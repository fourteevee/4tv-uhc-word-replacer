...
def main() -> None:
    ...
    with open(output_path, "w") as open_file:
        ...
        # Go wild.
        open_file.write("module.exports = {\n")
        open_file.write("    title: \"Mod where \\\"" + input_word +
                        "\\\" is replaced with \\\"" + output_word + "\\\"!\",\n")
        open_file.write("    author: \"Amelia P. "
                        "(<a href='https://github.com/fourteevee/tuhc-word-replacer'>GitHub</a>)\",\n")
        open_file.write("    modVersion: 2.0,\n")
        open_file.write("    description: `<h3>File auto-generated by the TUHC word replacer. All instances of \\\""
                        + input_word + "\\\" replaced with \\\"" + output_word + "\\\".</h3>`,\n")
        open_file.write("    trees: {\n")
        open_file.write("        './advimgs/': 'assets://advimgs/',\n")
        open_file.write("        './storyfiles/': 'assets://storyfiles/',\n")
        open_file.write("        './sweetbroandhellajeff/': 'assets://sweetbroandhellajeff/',\n")
        open_file.write("        './archive/comics/': 'assets://archive/comics/'\n")
        open_file.write("    },\n")
        open_file.write("\n")
        open_file.write("    edit(archive) {\n")
